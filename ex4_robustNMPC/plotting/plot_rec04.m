function plot_rec04(figNr, nrSteps, X_tight, U_tight, X, U, P, delta, params)
%PLOT REC 4 Summary of this function goes here
%   Detailed explanation goes here
    ...
    subplot(1,2,1)
    if any(X_tight.b <= 0)
        error("State tightening is larger than state constraints. Hence, the robust nonlinear MPC problem will always be infeasible!")
    end
